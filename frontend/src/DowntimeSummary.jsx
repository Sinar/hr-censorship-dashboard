...
class DowntimeSummaryWidget extends Component {
    constructor(props) {
        super(props);
    ...
    refresh(country) {
        fetch(
            `http://api.blockornot.today/api/history/country/${country}/year`
        ...
        return (
            <div>
                <Navbar color="light" light expand="md">
                    <NavbarBrand href="/">Yearly downtime summary</NavbarBrand>
...
export default connect(
    ...
    dispatch => ({
        handle_click(e, country) {
            ...
            this.props.delegate_navigate([country, 'year']);
