  ...
  year_get_button(year) {
    return (
      <Button
        key={year}
        color={
          (year === parseInt(this.props.match.params.year, 10) && "primary") ||
          "secondary"
        }
  ...
  summary_get_table() {
    let data =
      Object.entries(
        ...
        description: this.props.category?.[category_code]?.category_description,
        count: count,
      })) || [];
    return (
  ...
  category_get_sites(category) {
    return (
      this.props.site?.[this.props.match.params.country]?.[
        ...
        ?.reduce((current, site) => {
          let anomaly = this.props.chistory?.[this.props.match.params.year]?.[
            this.props.match.params.country
          ]?.[site.url];
    ...
    return (
      <div>
        ...
        {Object.entries(
          ...
          this.category_get_summary(this.props.category[category_code] || {})
        )}
      </div>
    );
  }
...
export default connect(
  ...
  (dispatch) => ({
    handle_click_country(e, country) {
      ...
      if (!this.props.chistory?.[this.props.match.params.year]?.[country]) {
        country_history_fetch(
          dispatch,
          this.props.delegate_loading_populate,
          this.props.delegate_loading_done,
    ...
    handle_click_year(e, year) {
      ...
      if (!this.props.chistory?.[year]?.[this.props.match.params.country]) {
        country_history_fetch(
          dispatch,
          this.props.delegate_loading_populate,
          this.props.delegate_loading_done,
